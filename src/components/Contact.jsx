...
// service_nk0wkxy
    ...
    emailjs.send('service_nk0wkxy',
    'template_ifqcfck',
    {
      from_name: form.name,
      to_name: 'Ifza',
      from_email: form.email,
      to_email: 'ifzayousaf2@gmail.com',
...
<button type='submit'
className='bg-tertiary py-3 px-8 ouline-none w-fit text-white font-bold shadow-primary rounded-xl'>
